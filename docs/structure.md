...
- E2E integration tests in `tests/e2e_*.rs` files, each gated behind `#[cfg(e2e_test)]`
  ...
  - 85 test cases total across 14 test files covering deletion, filtering, versioning, safety, callbacks, tracing, retry, optimistic locking, performance, statistics, error handling, AWS config, Express One Zone, and combined scenarios
