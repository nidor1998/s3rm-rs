...
> **Status**: Complete — all test cases implemented and passing (84 test functions across 14 test files + shared infrastructure, 84/84 pass verified 2026-02-24)

## E2E Test Requirements Checklist

- [x] Tests use `#![cfg(e2e_test)]` attribute (compiled only with `RUSTFLAGS="--cfg e2e_test"`)
- [x] All tests use the AWS profile `s3rm-e2e-test` (via `--target-profile s3rm-e2e-test`)
- [x] All E2E tests are executable in parallel (no shared state between tests; each test has a unique bucket)
- [x] Tests invoke the s3rm-rs library API (`build_config_from_args` + `DeletionPipeline`) -- not the CLI binary
- [x] Maximize source code coverage across all test cases
- [x] Test both Lua callbacks and Rust callbacks
- [x] No network disconnection/failure tests, BUT access denial tests ARE required
- [x] Bucket names are randomly generated per test case (use UUID v4 prefix: `s3rm-e2e-{uuid}`)
- [x] Post-processing ALWAYS runs regardless of test success/failure: delete all objects + delete bucket
- [x] Test data is auto-generated by the tests and uploaded to the target bucket (few KB per object, sufficient count)
- [x] Tests may use AWS SDK directly for test preparation (creating buckets, uploading objects, enabling versioning)
- [x] No performance testing in E2E tests
- [x] All CLI options tested; filtering options individually (one test per filter type); other options grouped logically
- [x] Maximum 1000 objects per E2E test case
- [x] Each test function name must be descriptive and clearly convey what is being tested
- [x] Each test function MUST begin with a detailed comment block explaining: (1) the purpose of the test, (2) the test setup, (3) the expected results. This is required for human review.

## E2E Test Infrastructure

- [x] 29.0 Create shared test helper module (`tests/common/mod.rs`)
...
- [x] 29.1 `e2e_filter_include_regex`
...
- [x] 29.2 `e2e_filter_exclude_regex`
...
- [x] 29.3 `e2e_filter_include_content_type_regex`
...
- [x] 29.4 `e2e_filter_exclude_content_type_regex`
...
- [x] 29.5 `e2e_filter_include_metadata_regex`
...
- [x] 29.6 `e2e_filter_exclude_metadata_regex`
...
- [x] 29.6a `e2e_filter_include_metadata_regex_multiple_entries`
...
- [x] 29.6b `e2e_filter_exclude_metadata_regex_multiple_entries_alternation`
...
- [x] 29.7 `e2e_filter_include_tag_regex`
...
- [x] 29.8 `e2e_filter_exclude_tag_regex`
...
- [x] 29.8a `e2e_filter_include_tag_regex_multiple_tags`
...
- [x] 29.8b `e2e_filter_exclude_tag_regex_multiple_tags_alternation`
...
- [x] 29.9 `e2e_filter_mtime_before`
...
- [x] 29.10 `e2e_filter_mtime_after`
...
- [x] 29.11 `e2e_filter_smaller_size`
...
- [x] 29.12 `e2e_filter_larger_size`
...
- [x] 29.13 `e2e_basic_prefix_deletion`
...
- [x] 29.14 `e2e_batch_deletion_mode`
...
- [x] 29.15 `e2e_single_deletion_mode`
...
- [x] 29.16 `e2e_delete_entire_bucket_contents`
...
- [x] 29.17 `e2e_empty_bucket_no_error`
...
- [x] 29.18 `e2e_dry_run_no_deletion`
...
- [x] 29.19 `e2e_max_delete_threshold`
...
- [x] 29.20 `e2e_force_flag_skips_confirmation`
...
- [x] 29.21 `e2e_versioned_bucket_creates_delete_markers`
...
- [x] 29.22 `e2e_delete_all_versions`
...
- [x] 29.24 `e2e_rust_filter_callback`
...
- [x] 29.25 `e2e_rust_event_callback`
...
- [x] 29.26 `e2e_lua_filter_callback`
...
- [x] 29.27 `e2e_lua_event_callback`
...
- [x] 29.28 `e2e_lua_sandbox_blocks_os_access`
...
- [x] 29.29 `e2e_lua_vm_memory_limit`
...
- [x] 29.30 `e2e_rust_filter_and_event_callbacks_combined`
...
- [x] 29.31 `e2e_if_match_single_deletion`
...
- [x] 29.32 `e2e_if_match_batch_deletion`
...
- [x] 29.32a `e2e_if_match_etag_mismatch_skips_modified_objects`
...
- [x] 29.33 `e2e_worker_size_configuration`
...
- [x] 29.34 `e2e_rate_limit_objects`
...
- [x] 29.35 `e2e_max_parallel_listings`
...
- [x] 29.36 `e2e_object_listing_queue_size`
...
- [x] 29.42 `e2e_disable_color_tracing`
...
- [x] 29.43 `e2e_log_deletion_summary`
...
- [x] 29.44 `e2e_aws_sdk_tracing_and_span_events`
...
- [x] 29.47 `e2e_disable_stalled_stream_protection`
...
- [x] 29.48 `e2e_access_denied_invalid_credentials`
...
- [x] 29.49 `e2e_nonexistent_bucket_error`
...
- [x] 29.49a `e2e_batch_partial_failure_access_denied`
...
- [x] 29.51 `e2e_target_region_override`
...
- [x] 29.52 `e2e_target_force_path_style`
...
- [x] 29.53 `e2e_target_request_payer`
...
- [x] 29.53a `e2e_allow_lua_unsafe_vm`
...
- [x] 29.54 `e2e_multiple_filters_combined`
...
- [x] 29.55 `e2e_dry_run_with_delete_all_versions`
...
- [x] 29.56 `e2e_dry_run_with_filters`
...
- [x] 29.57 `e2e_max_delete_with_filters`
...
- [x] 29.58 `e2e_lua_filter_with_event_callback`
...
- [x] 29.59 `e2e_large_object_count`
...
- [x] 29.59a `e2e_all_filters_combined`
...
- [x] 29.60 `e2e_deletion_stats_accuracy`
...
- [x] 29.61 `e2e_event_callback_receives_all_event_types`
