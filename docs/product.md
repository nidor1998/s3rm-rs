...
- Bulk deletion up to ~3,500 objects/second for standard buckets (~34,000 objects/second for Express One Zone with --worker-size 256 --allow-parallel-listings-in-express-one-zone)
